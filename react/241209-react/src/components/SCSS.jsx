...
function SCSS() {
  return (
    <section className={styles.wrapper}>
      ...
      <div className={`${styles.container} ${styles.salmon}`}>slamon</div>
      <div className={`${styles.container} ${styles.orange}`}>orange</div>
      <div className={`${styles.container} ${styles.maroon}`}>maroon</div>
    </section>
  );
}
